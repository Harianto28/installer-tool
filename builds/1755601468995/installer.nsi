; Script generated by the HM NIS Edit Script Wizard.
 !define PRODUCT_NAME "Testing"
 !define PRODUCT_VERSION "v1.0.0"
 !define PRODUCT_DIR "C:\MyApp"
 
   OutFile "Testing_Installer-100.exe"
  InstallDir "C:\MyApp"
 Caption "Testing v1.0.0"
 ...
 Page instfiles ; This page actually performs the installation process
  ...
  Function CleanupTempFiles
    ; Clean up any remaining ZIP files
      Delete "$INSTDIR\michatv2admin-main.zip"
  DetailPrint "Cleaned up michatv2admin-main.zip"
  FunctionEnd
...
Section "Section 1" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File "sertifikasi cdm.jpg"
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File "michatv2admin-main.zip"
  SetOutPath "$INSTDIR\michatv2admin-main"
  SetOverwrite on
  nsisunz::UnzipToLog "$INSTDIR\michatv2admin-main.zip" "$INSTDIR\michatv2admin-main"
  Pop $0
  ${If} $0 != "OK"
    DetailPrint "Failed to unzip michatv2admin-main.zip: $0"
    ; ZIP file kept for debugging since unzip failed
  ${Else}
    DetailPrint "Successfully unzipped michatv2admin-main.zip to $INSTDIR\michatv2admin-main"
    ; Clean up the ZIP file after successful extraction
    DetailPrint "Attempting to delete michatv2admin-main.zip from $INSTDIR"
    Delete "$INSTDIR\michatv2admin-main.zip"
    DetailPrint "Successfully cleaned up michatv2admin-main.zip"
  ${EndIf}
